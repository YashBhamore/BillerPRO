...
const heroImage = 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop';
          ...
          >
            ...
            <div className="flex-[1.2] relative flex items-center justify-center overflow-hidden">
              ...
              <motion.div
                ...
                className="relative z-10 w-[75%] max-w-[260px] aspect-[3/4] rounded-2xl overflow-hidden"
                style={{
                  border: '3px solid rgba(217, 119, 87, 0.15)',
                  boxShadow: '0 12px 40px rgba(217, 119, 87, 0.12), 0 4px 12px rgba(26, 24, 22, 0.06)',
                }}
              >
                <img
                  src={heroImage}
                ...
                />
                {/* Warm overlay tint to unify with color palette */}
                <div
                  className="absolute inset-0 pointer-events-none"
                  style={{
                    background: 'linear-gradient(180deg, rgba(217,119,87,0.04) 0%, rgba(250,249,246,0.15) 100%)',
                  }}
                />
              </motion.div>
